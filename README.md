...
The quantum simulation engine ([`@quantum-native/quantum-forge-chess`](https://www.npmjs.com/package/@quantum-native/quantum-forge-chess)) is included as a dependency and has its own [license](https://quantum.dev).
